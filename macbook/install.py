...
def main():
    ...
    run_commands("Install MesloLG Nerd Font", ["curl -LO https://github.com/ryanoasis/nerd-fonts/releases/download/v3.4.0/Meslo.zip", "unzip ./Meslo.zip", "sudo cp ./Meslo/*.ttf /Library/Fonts/", "sudo cp ./Meslo/*.otf /Library/Fonts/"])
