...
def main():
    ...
    run_commands("Install MesloLG Nerd Font", ["curl -LO https://github.com/ryanoasis/nerd-fonts/releases/download/v3.4.0/Meslo.zip", "unzip ./Meslo.zip", "sudo cp *.ttf /Library/Fonts/", "sudo cp *.otf /Library/Fonts/"])
